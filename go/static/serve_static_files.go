...
import (
	...
	"github.com/thomaspeugeot/gongreqif"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongreqif.NgDistNg, "ng-github.com-thomaspeugeot-gongreqif/dist/ng-github.com-thomaspeugeot-gongreqif/browser")))
