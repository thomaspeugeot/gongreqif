...
func GetInstanceDBFromInstance[T models.Gongstruct, T2 GongstructDB](
	...
	case *models.REQIFTOOLEXTENSION:
		...
		ret = any(ret2).(*T2)
	case *models.REQTYPE:
		reqtypeInstance := any(concreteInstance).(*models.REQTYPE)
		ret2 := backRepo.BackRepoREQTYPE.GetREQTYPEDBFromREQTYPEPtr(reqtypeInstance)
		ret = any(ret2).(*T2)
	case *models.SOURCE:
...
func GetID[T models.Gongstruct](
	...
	case *models.REQIFTOOLEXTENSION:
		...
		id = int(tmp.ID)
	case *models.REQTYPE:
		tmp := GetInstanceDBFromInstance[models.REQTYPE, REQTYPEDB](
			stage, backRepo, inst,
		)
		id = int(tmp.ID)
	case *models.SOURCE:
